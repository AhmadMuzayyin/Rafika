...
class AdminArsipController extends Controller
{
    public function index()
    {
        if (request()->get('dana') != null) {
            $data = Bulan::all();
            $dana = SumberDana::all();
            $opd = User::where('isAdmin', false)->get();
            $userSelected = request()->get('skpd');
            $selected = request()->get('dana');
            return view('admin.arsip.index', compact('data', 'dana', 'selected', 'opd', 'userSelected'));
        } else {
            $data = Bulan::all();
            $dana = SumberDana::all();
            $opd = User::where('isAdmin', false)->get();
    ...
    public function cover(Request $request)
    {
        ...
        try {
            ...
            $skpd = User::firstWhere('id', $request->skpd);
            ...
            return view('admin.arsip.cover', compact('data', 'main', 'realKegiatan', 'realKeuangan'));
    ...
    public function jadwal(Request $request)
    {
        ...
        try {
            ...
            $bulan = Bulan::all();
            return view('admin.arsip.jadwal', compact('data', 'bulan', 'thn', 'dana'));
        } catch (\Exception $th) {
            return redirect()->back()->with('info', 'Tidak ada data untuk ditampilkan!');
        }
    }
    public function rfk(Request $request)
    {
        ...
        try {
            ...
            $bulan = Bulan::all();
            return view('admin.arsip.rfk', compact('data', 'bulan', 'thn', 'dana', 'bl'));
        } catch (\Exception $th) {
            return redirect()->back()->with('info', 'Tidak ada data untuk ditampilkan!');
        }
    }
    public function grafik(Request $request)
    {
        ...
        try {
            ...
            return view('admin.arsip.grafik', compact('data', 'thn', 'dana', 'bl', 'grafik'));
        } catch (QueryException $th) {
            return redirect()->back()->with('info', 'Tidak ada data untuk ditampilkan!');
        }
    }
